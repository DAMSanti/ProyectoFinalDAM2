class Alojamiento {
  ...
  factory Alojamiento.fromJson(Map<String, dynamic> json) {
    return Alojamiento(
      ...
      precioPorNoche: json['precioPorNoche'] != null
          ? (json['precioPorNoche'] as num).toDouble()
          : null,
  ...
  // Método auxiliar para obtener los servicios como lista
  List<String> get listaServicios {
    if (servicios == null || servicios!.isEmpty) return [];
    return servicios!.split(',').map((s) => s.trim()).toList();
  }
}
